...
export interface RedistributionPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "distributionCursor",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace DistributedEvent {
  export type InputTuple = [
    recipientsProcessed: BigNumberish,
    amountPerRecipient: BigNumberish,
    timestamp: BigNumberish,
    newCursor: BigNumberish
  ];
  export type OutputTuple = [
    recipientsProcessed: bigint,
...
export interface RedistributionPool extends BaseContract {
  connect(runner?: ContractRunner | null): RedistributionPool;
  waitForDeployment(): Promise<this>;

  interface: RedistributionPoolInterface;
  ...
  distributionCursor: TypedContractMethod<[], [bigint], "view">;
  ...
  ): TypedContractMethod<[maxRecipients: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "distributionCursor"
  ...
  filters: {
    ...
    "Distributed(uint256,uint256,uint64,uint256)": TypedContractEvent<
      DistributedEvent.InputTuple,
      DistributedEvent.OutputTuple,
      DistributedEvent.OutputObject
    >;
