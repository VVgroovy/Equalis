...
export interface EqualisGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface EqualisGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): EqualisGovernor;
  waitForDeployment(): Promise<this>;

  interface: EqualisGovernorInterface;
