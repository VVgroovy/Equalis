...
export interface TimelockSetupInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface TimelockSetup extends BaseContract {
  connect(runner?: ContractRunner | null): TimelockSetup;
  waitForDeployment(): Promise<this>;

  interface: TimelockSetupInterface;
